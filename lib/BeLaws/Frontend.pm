    ...
    $result = qq|<!DOCTYPE html>
        <html>
            <head>
                ...
                <link rel="alternate" type="application/json+oembed" href="http://eleven.broga.be:6061/oembed/$lang/$docuid" title="oEmbed Profile" />
            </head>
            <body>
    ...
    if(-e "./static/$lang/$year/$no/$art.html") {
        ...
        if($res->[0] == 200) {
            ...
            if($p) {
                ...
                binmode($fh);
                print $fh qq|<link rel="alternate" type="application/json+oembed" href="http://eleven.broga.be:6061/oembed/$lang/$year/$no/$art" title="oEmbed Profile" />|;
    ...
    if($art) {
        ...
        return $res unless $res->[0] == 200;
            ...
            my $obj = {
                version => "1.0",
                title => "$title",
                html => qq|<iframe width="100%" height="350px;" frameborder="0" src="http://eleven.broga.be:6061/$lang/$year/$no/$art"></iframe>|,
            };
